module ActivityStringHelper
  ...
  def as_for_questions_create(act, owner_string, your, embedded_link= false)
    ...
    activity_string = t("activities.questions.create#{your}", type: question_type(act.recipient), thing: thing)
  ...
  def as_for_motions_create(act, owner_string, your, embedded_link= false)
    ...
    activity_string = t("activities.motions.create#{your}", type: motion_type(item.forum), thing: thing)
    "#{owner_string} #{activity_string}"
  end
  ...
  def as_for_arguments_create(act, owner_string, your, embedded_link= false)
    ...
    activity_string = t("activities.arguments.create#{your}", type: argument_type(act.trackable.forum),thing: thing)
    "#{owner_string} #{activity_string}"
  end
  ...
  def as_for_votes_create(act, owner_string, your, embedded_link= false)
    ...
    activity_string = t("activities.votes.voted.#{act.parameters[:for]}#{your}", thing: thing)
    "#{owner_string} #{activity_string}"
  end
