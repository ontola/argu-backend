...
module GroupResponsesHelper
  ...
  def header_values(group)
    {
        'pro' => t('group_responses.header.pro', type: group.name),
        'neutral' => t('group_responses.header.neutral', type: group.name),
        'con' => t('group_responses.header.con', type: group.name)
    }
  end
