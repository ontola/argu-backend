...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{ Authentication Document Edit Forum Identity Membership Notification Page PageMembership Profile Setting Shortname User }
  ...
  #
  config.tenant_names = lambda { Shortname.where(owner_type: 'Forum').pluck :shortname }
