Argu::Application.routes.draw do
  ...
  ##get "users/new"
  get "/settings", to: "users#show", as: 'user', constraints: lambda { |r| r.env["warden"].authenticate? }
  post '/settings' => 'users#update', as: 'user', constraints: lambda { |r| r.env["warden"].authenticate? }
