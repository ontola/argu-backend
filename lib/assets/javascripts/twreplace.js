// https://github.com/samjdavis13/twreplace
// Used for the blocks component that replaces one word
...
export default function twReplace() {
...
function playTicker(element, content, wordSpeed, charSpeed) {
    if (typeof wordSpeed === "undefined") { wordSpeed = 3000; }
    if (typeof charSpeed === "undefined") { charSpeed = 50; }
    var lastUsedIndex = 0;
