...
PermittedAction.create_for_grant_sets('SwipeTool', 'update', administrator_plus)
PermittedAction.create_for_grant_sets('SwipeTool', 'create', administrator_plus)
...
PermittedAction.create_for_grant_sets('Poll', 'destroy', staff)
