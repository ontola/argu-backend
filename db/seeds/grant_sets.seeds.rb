...
moderator_plus = GrantSet.reserved(only: %w[moderator administrator])
...
administrator_plus = GrantSet.reserved(only: %w[administrator])
...
PermittedAction.create_for_grant_sets('CustomForm', 'create', administrator_plus)
