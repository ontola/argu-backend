...
%w[Page Forum ORIForum Question Motion LinkedRecord ConArgument ProArgument
...
show_actions =
  %i[page_show forum_show ori_forum_show question_show motion_show linked_record_show pro_argument_show
...
staff.permitted_actions <<
  %i[page_update forum_update ori_forum_update question_update motion_update
     pro_argument_update con_argument_update blog_post_update decision_update].map { |a| @actions[a] }
staff.permitted_actions <<
  %i[question_trash motion_trash pro_argument_trash con_argument_trash
     blog_post_trash comment_trash].map { |a| @actions[a] }
staff.permitted_actions <<
  %i[page_destroy forum_destroy ori_forum_destroy question_destroy motion_destroy pro_argument_destroy
     con_argument_destroy blog_post_destroy comment_destroy].map { |a| @actions[a] }
