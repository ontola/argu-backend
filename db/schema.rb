...
ActiveRecord::Schema.define(version: 20170602134212) do
  ...
  create_table "grants", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["group_id", "edge_id"], name: "index_grants_on_group_id_and_edge_id", unique: true, using: :btree
  end
  ...
  create_table "vote_matches", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["creator_id", "shortname"], name: "index_vote_matches_on_creator_id_and_shortname", unique: true, using: :btree
  end
