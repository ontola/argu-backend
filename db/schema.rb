...
ActiveRecord::Schema.define(:version => 20121116) do
  ...
  add_index "arguments", ["argument_id"], name: "argument_id", unique: true
  ...
  add_index "statements", ["statement_id"], name: "statement_id", unique: true
