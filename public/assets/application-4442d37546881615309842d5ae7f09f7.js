...
(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/all.js#xfbml=1&appId=269911176456825";
...
(function() {
    if (!document.getElementById('argu-acss'))
    {
        ...
        link.rel  = 'stylesheet';
        link.type = 'text/css';
        link.href = '//home.fletcher91.com:3000/assets/widgets/argu.css';
        link.media = 'all';
    ...
    var Statement = function () {
        ...
        for(var i = 0; i < statements.length; i++) {
            ...
            req.open("get", "//home.fletcher91.com:3000/statements/" + statement.id + '.widget', true);
            req.send();
        }
    };
    ...
    var Argument = function () {
        ...
        for(var i = 0; i < arguments.length; i++) {
            ...
            req.open("get", "//home.fletcher91.com:3000/arguments/" + argument.id + '.widget', true);
            req.send();
        }
    };
