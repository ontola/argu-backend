...
(function() {
    if (!document.getElementById('argu-acss'))
    {
        ...
        link.rel  = 'stylesheet';
        link.type = 'text/css';
        link.href = '//argu.nl/assets/widgets/argu-0e956a09158d5eca84325b5d93e9d4d9.css';
        link.media = 'all';
    ...
    var Statement = function () {
        ...
        for(var i = 0; i < statements.length; i++) {
            ...
            req.open("get", "//argu.nl/statements/" + statement.id + '.widget', true);
            req.send();
        }
    };
    ...
    var Argument = function () {
        ...
        for(var i = 0; i < arguments.length; i++) {
            ...
            req.open("get", "//argu.nl/arguments/" + argument.id + '.widget', true);
            req.send();
        }
    };
