...
class ProArgumentsControllerTest < ActionController::TestCase
  ...
  test 'should get index arguments of motion with' do
    ...
    expect_default_view
    expect_included(collection_iri(motion, :pro_arguments, page: 1, page_size: 10))
  ...
  test 'should get index arguments of linked_record' do
    ...
    expect_included(collection_iri(linked_record, :pro_arguments, page: 1, page_size: 10))
    expect_not_included(collection_iri(linked_record, :con_arguments, page: 1, page_size: 10))
  ...
  test 'should get index arguments of non_persisted_linked_record' do
    ...
    expect_included(collection_iri(non_persisted_linked_record, :pro_arguments, page: 1, page_size: 10))
    expect_not_included(collection_iri(non_persisted_linked_record, :con_arguments, page: 1, page_size: 10))
  end
end
