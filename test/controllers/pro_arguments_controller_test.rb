...
class ProArgumentsControllerTest < ActionController::TestCase
  ...
  test 'should get index arguments of non_persisted_linked_record' do
    ...
    expect_included(collection_iri(non_persisted_linked_record, :pro_arguments, page: 1))
    expect_not_included(collection_iri(non_persisted_linked_record, :con_arguments, page: 1))
  end
end
