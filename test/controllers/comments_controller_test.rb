...
class CommentsControllerTest < ActionController::TestCase
  ...
  test 'should get show comment' do
    get :show, params: {format: :json_api, id: comment.edge.fragment, root_id: argu.id}
    assert_response 200
  ...
  test 'should get index comments of argument' do
    get :index, params: {format: :json_api, root_id: argu.id, pro_argument_id: argument.edge.fragment}
    assert_response 200
  ...
  test 'should get index comments of argument with page=1' do
    get :index, params: {format: :json_api, root_id: argu.id, pro_argument_id: argument.edge.fragment, page: 1}
    assert_response 200
  ...
  test 'should get index comments of blog_post' do
    get :index, params: {format: :json_api, root_id: argu.id, blog_post_id: blog_post.edge.fragment}
    assert_response 200
  ...
  test 'should get index comments of blog_post with page=1' do
    get :index, params: {format: :json_api, root_id: argu.id, blog_post_id: blog_post.edge.fragment, page: 1}
    assert_response 200
